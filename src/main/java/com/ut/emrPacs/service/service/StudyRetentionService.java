...
public interface StudyRetentionService {
    ...
    ResponseMessage<BaseResult> findPolicy(Long id, HttpServletRequest httpServletRequest) throws UnknownHostException;
    ...
    ResponseMessage<BaseResult> bulkDelete(StudyRetentionBulkDeleteRequest request, HttpServletRequest httpServletRequest) throws UnknownHostException;

    ResponseMessage<BaseResult> runAutoDelete(StudyRetentionAutoDeleteRequest request, HttpServletRequest httpServletRequest) throws UnknownHostException;
